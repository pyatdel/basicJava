...
public class T02ServletTest extends HttpServlet {
	 ...
	 *  2. 컨테이너는 web.xml에 정의된 Url 패턴을 확인하여 어느 서블릿을 통해 요청을 처리할지를 
	 ...
	 *  
	 *  5. 요청 처리가 완료돈 HttpServletRequest 및 HttpServletResoponse객체는 소멸된다.
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 파라미터  클라이언트(브라우저)   String 
		// 애트리뷰트 세션등에 담을수 있다.  Object 담을수 있다.
