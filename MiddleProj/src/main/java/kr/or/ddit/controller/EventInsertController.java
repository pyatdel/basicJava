...
//	String uploadPath = "../../../../../../../WebContent/resources/boogie/edu-meeting/assets/images/"; // init -> xml?
//	String uploadPath = "WebContent/resources/boogie/edu-meeting/assets/images"; // init -> xml?
//	String uploadPath = "/MiddleProj/WebContent/resources/boogie/edu-meeting/assets/images"; // init -> xml?
//	String upload_dir = "upload_files"; // init -> xml?
//	String uploadPath = "${contextPath }/resources/boogie/edu-meeting/assets/images/";
...
//		File uploadDir = new File(uploadPath);
	    ...
	    String boardStart = req.getParameter("startDate");
	    String boardEnd = req.getParameter("endDate");
//	    int memNo = Integer.parseInt(req.getParameter("memNo"));
	    // 파일 파트 가져오기
	 
//	    1. getPart로 파트 html태그 이름을 써서 파일 갖고오기
	    Part part = req.getPart("attachedFiles");
	    Part part2 = req.getPart("attachedFiles2");
...
//	    5. 파일을 저장한다
    	...
    	event.setBoardImg("null"); // 파일명 저장
	    
	    event.setBoardStart(boardStart);
	    event.setBoardEnd(boardEnd);

    	event.setBoardThumb("https://image.ohou.se/i/bucketplace-v2-development/uploads/productions/1557828582299_MBRS6Sprm8.gif?gif=1&w=72&h=72&c=c");
	    
	    System.out.println("boardStart: " + boardStart);
	    System.out.println("boardEnd: " + boardEnd);
	    // 서비스 호출
