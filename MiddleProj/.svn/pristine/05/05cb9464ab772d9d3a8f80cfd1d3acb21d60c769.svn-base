...
public class MovieDaoImpl  extends MyBatisDao implements iMovieDao {
	...
	public List<MovieVo> movieList(MovieVo searchMovie) {
		return selectList("movie.movieList",searchMovie);
	}
	...
	@Override
	public int getTotal() {
		return selectOne("movie.getTotal");
	}
	...
	public List<MovieVo> selmoviebygen(String genName) {
		return selectList("movie.selmoviebygen",genName);
	}

	@Override
	public List<GenreVo> selgenbymovie(String movieNo) {
		return selectList("movie.selgenbymovie",movieNo);
	}
