...
<!--     <input type="button" value="뒤로가기" onclick="location.href='eventList'"> -->
	<table border = "">
		...
		<tbody>
			<tr><font color="white">
				<td colspan="9"  style="text-align: center;"><font color="white"><%= event.getBoardContent() %>
				
				<img src="<%= event.getBoardImg() %> " alt="<%= event.getBoardImg() %>" style="display: block; margin: auto;" >
				</td>
			</tr>
		</tbody>
	</table>
